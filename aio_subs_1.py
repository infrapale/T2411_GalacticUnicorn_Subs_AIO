...
MQTT_TOPIC_VA_MODE = 'infrapale/feeds/villaastrid.astrid-mode'
MQTT_TOPIC_RUUVI_E6 = 'infrapale/feeds/villaastrid.ruuvi-e6'

# MQTT_TOPIC_LED = 'villaastrid.astrid-mode'
...
try:
    ...
    if not initialize_wifi(config.wifi_ssid, config.wifi_password):
        ...
        subscribe(client, MQTT_TOPIC_VA_MODE)
        subscribe(client, MQTT_TOPIC_RUUVI_E6)
